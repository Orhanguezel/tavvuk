...
SELECT
  ...
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000000101'), 90) DAY) + INTERVAL 1 HOUR,
  '11111111-1111-4111-8111-111111111111',
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000000101'), 90) DAY) + INTERVAL 2 HOUR,
  NULL, NULL,
  0, 0,
  NULL,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000000101'), 90) DAY),
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000000101'), 90) DAY) + INTERVAL 2 HOUR + INTERVAL 10 MINUTE
FROM cities c
...
SELECT
  ...
  x.qty,
  0,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000000101'), 90) DAY) + INTERVAL 20 MINUTE,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000000101'), 90) DAY) + INTERVAL 20 MINUTE
FROM (
  SELECT
...
SELECT
  ...
  '11111111-1111-4111-8111-111111111111',
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000000102'), 90) DAY) + INTERVAL 1 HOUR,
  NULL, NULL,
  NULL, NULL,
  0, 0,
  NULL,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000000102'), 90) DAY),
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000000102'), 90) DAY) + INTERVAL 1 HOUR + INTERVAL 10 MINUTE
FROM cities c
...
SELECT
  ...
  NULL,
  '11111111-1111-4111-8111-111111111111',
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000000201'), 90) DAY) + INTERVAL 1 HOUR,
  '11111111-1111-4111-8111-111111111111',
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000000201'), 90) DAY) + INTERVAL 2 HOUR,
  NULL, NULL,
  0, 0,
  NULL,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000000201'), 90) DAY),
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000000201'), 90) DAY) + INTERVAL 2 HOUR + INTERVAL 10 MINUTE
FROM cities c
...
SELECT
  ...
  x.qty,
  0,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000000201'), 90) DAY) + INTERVAL 20 MINUTE,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000000201'), 90) DAY) + INTERVAL 20 MINUTE
FROM (
  SELECT
...
SELECT
  ...
  0, 0,
  'customer_cancelled',
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000000202'), 90) DAY),
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000000202'), 90) DAY) + INTERVAL 10 MINUTE
FROM cities c
...
SELECT
  ...
  NULL,
  '11111111-1111-4111-8111-111111111111',
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000000301'), 90) DAY) + INTERVAL 1 HOUR,
  '11111111-1111-4111-8111-111111111111',
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000000301'), 90) DAY) + INTERVAL 2 HOUR,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000000301'), 90) DAY) + INTERVAL 6 HOUR,
  'Teslim edildi (seed).',
  12,
  1,
  NULL,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000000301'), 90) DAY),
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000000301'), 90) DAY) + INTERVAL 6 HOUR + INTERVAL 10 MINUTE
FROM cities c
...
SELECT
  ...
  x.qo,
  x.qd,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000000301'), 90) DAY) + INTERVAL 20 MINUTE,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000000301'), 90) DAY) + INTERVAL 20 MINUTE
FROM (
  SELECT
...
SELECT
  ...
  0, 0,
  NULL,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000000401'), 90) DAY),
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000000401'), 90) DAY) + INTERVAL 10 MINUTE
FROM cities c
...
SELECT
  ...
  NULL,
  '11111111-1111-4111-8111-111111111111',
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000000501'), 90) DAY) + INTERVAL 1 HOUR,
  '11111111-1111-4111-8111-111111111111',
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000000501'), 90) DAY) + INTERVAL 2 HOUR,
  NULL, NULL,
  0, 0,
  NULL,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000000501'), 90) DAY),
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000000501'), 90) DAY) + INTERVAL 2 HOUR + INTERVAL 10 MINUTE
FROM cities c
...
SELECT
  ...
  x.qty,
  0,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000000501'), 90) DAY) + INTERVAL 20 MINUTE,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000000501'), 90) DAY) + INTERVAL 20 MINUTE
FROM (
  SELECT
...
SELECT
  ...
  0, 0,
  NULL,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000000901'), 90) DAY),
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000000901'), 90) DAY) + INTERVAL 10 MINUTE
FROM cities c
...
SELECT
  ...
  NULL,
  '11111111-1111-4111-8111-111111111111',
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001001'), 90) DAY) + INTERVAL 1 HOUR,
  '11111111-1111-4111-8111-111111111111',
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001001'), 90) DAY) + INTERVAL 2 HOUR,
  NULL,
  NULL,
  0,
  0,
  NULL,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001001'), 90) DAY),
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001001'), 90) DAY) + INTERVAL 2 HOUR + INTERVAL 10 MINUTE
FROM cities c
...
SELECT
  ...
  x.qty,
  x.qty_del,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001001'), 90) DAY) + INTERVAL 20 MINUTE,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001001'), 90) DAY) + INTERVAL 20 MINUTE
FROM (
...
SELECT
  ...
  NULL,
  '11111111-1111-4111-8111-111111111111',
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001002'), 90) DAY) + INTERVAL 1 HOUR,
  '11111111-1111-4111-8111-111111111111',
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001002'), 90) DAY) + INTERVAL 2 HOUR,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001002'), 90) DAY) + INTERVAL 6 HOUR,
  'Teslim edildi (extended seed).',
  25,
  1,
  NULL,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001002'), 90) DAY),
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001002'), 90) DAY) + INTERVAL 6 HOUR + INTERVAL 10 MINUTE
FROM cities c
...
SELECT
  ...
  x.qty,
  x.qty_del,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001002'), 90) DAY) + INTERVAL 20 MINUTE,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001002'), 90) DAY) + INTERVAL 20 MINUTE
FROM (
...
SELECT
  ...
  NULL,
  '11111111-1111-4111-8111-111111111111',
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001003'), 90) DAY) + INTERVAL 1 HOUR,
  '11111111-1111-4111-8111-111111111111',
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001003'), 90) DAY) + INTERVAL 2 HOUR,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001003'), 90) DAY) + INTERVAL 6 HOUR,
  'Teslim edildi (extended seed).',
  15,
  1,
  NULL,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001003'), 90) DAY),
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001003'), 90) DAY) + INTERVAL 6 HOUR + INTERVAL 10 MINUTE
FROM cities c
...
SELECT
  ...
  x.qty,
  x.qty_del,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001003'), 90) DAY) + INTERVAL 20 MINUTE,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001003'), 90) DAY) + INTERVAL 20 MINUTE
FROM (
...
SELECT
  ...
  NULL,
  '11111111-1111-4111-8111-111111111111',
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001004'), 90) DAY) + INTERVAL 1 HOUR,
  '11111111-1111-4111-8111-111111111111',
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001004'), 90) DAY) + INTERVAL 2 HOUR,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001004'), 90) DAY) + INTERVAL 6 HOUR,
  'Teslim edildi (extended seed).',
  25,
  1,
  NULL,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001004'), 90) DAY),
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001004'), 90) DAY) + INTERVAL 6 HOUR + INTERVAL 10 MINUTE
FROM cities c
...
SELECT
  ...
  x.qty,
  x.qty_del,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001004'), 90) DAY) + INTERVAL 20 MINUTE,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001004'), 90) DAY) + INTERVAL 20 MINUTE
FROM (
...
SELECT
  ...
  NULL,
  '11111111-1111-4111-8111-111111111111',
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001005'), 90) DAY) + INTERVAL 1 HOUR,
  '11111111-1111-4111-8111-111111111111',
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001005'), 90) DAY) + INTERVAL 2 HOUR,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001005'), 90) DAY) + INTERVAL 6 HOUR,
  'Teslim edildi (extended seed).',
  25,
  1,
  NULL,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001005'), 90) DAY),
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001005'), 90) DAY) + INTERVAL 6 HOUR + INTERVAL 10 MINUTE
FROM cities c
...
SELECT
  ...
  x.qty,
  x.qty_del,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001005'), 90) DAY) + INTERVAL 20 MINUTE,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001005'), 90) DAY) + INTERVAL 20 MINUTE
FROM (
...
SELECT
  ...
  NULL,
  '11111111-1111-4111-8111-111111111111',
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001006'), 90) DAY) + INTERVAL 1 HOUR,
  '11111111-1111-4111-8111-111111111111',
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001006'), 90) DAY) + INTERVAL 2 HOUR,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001006'), 90) DAY) + INTERVAL 6 HOUR,
  'Teslim edildi (extended seed).',
  58,
  1,
  NULL,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001006'), 90) DAY),
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001006'), 90) DAY) + INTERVAL 6 HOUR + INTERVAL 10 MINUTE
FROM cities c
...
SELECT
  ...
  x.qty,
  x.qty_del,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001006'), 90) DAY) + INTERVAL 20 MINUTE,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001006'), 90) DAY) + INTERVAL 20 MINUTE
FROM (
...
SELECT
  ...
  NULL,
  '11111111-1111-4111-8111-111111111111',
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001007'), 90) DAY) + INTERVAL 1 HOUR,
  '11111111-1111-4111-8111-111111111111',
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001007'), 90) DAY) + INTERVAL 2 HOUR,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001007'), 90) DAY) + INTERVAL 6 HOUR,
  'Teslim edildi (extended seed).',
  33,
  1,
  NULL,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001007'), 90) DAY),
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001007'), 90) DAY) + INTERVAL 6 HOUR + INTERVAL 10 MINUTE
FROM cities c
...
SELECT
  ...
  x.qty,
  x.qty_del,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001007'), 90) DAY) + INTERVAL 20 MINUTE,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001007'), 90) DAY) + INTERVAL 20 MINUTE
FROM (
...
SELECT
  ...
  NULL,
  '11111111-1111-4111-8111-111111111111',
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001008'), 90) DAY) + INTERVAL 1 HOUR,
  '11111111-1111-4111-8111-111111111111',
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001008'), 90) DAY) + INTERVAL 2 HOUR,
  NULL,
  NULL,
  0,
  0,
  NULL,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001008'), 90) DAY),
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001008'), 90) DAY) + INTERVAL 2 HOUR + INTERVAL 10 MINUTE
FROM cities c
...
SELECT
  ...
  x.qty,
  x.qty_del,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001008'), 90) DAY) + INTERVAL 20 MINUTE,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001008'), 90) DAY) + INTERVAL 20 MINUTE
FROM (
...
SELECT
  ...
  NULL,
  '11111111-1111-4111-8111-111111111111',
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001009'), 90) DAY) + INTERVAL 1 HOUR,
  '11111111-1111-4111-8111-111111111111',
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001009'), 90) DAY) + INTERVAL 2 HOUR,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001009'), 90) DAY) + INTERVAL 6 HOUR,
  'Teslim edildi (extended seed).',
  46,
  1,
  NULL,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001009'), 90) DAY),
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001009'), 90) DAY) + INTERVAL 6 HOUR + INTERVAL 10 MINUTE
FROM cities c
...
SELECT
  ...
  x.qty,
  x.qty_del,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001009'), 90) DAY) + INTERVAL 20 MINUTE,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001009'), 90) DAY) + INTERVAL 20 MINUTE
FROM (
...
SELECT
  ...
  NULL,
  '11111111-1111-4111-8111-111111111111',
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001010'), 90) DAY) + INTERVAL 1 HOUR,
  '11111111-1111-4111-8111-111111111111',
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001010'), 90) DAY) + INTERVAL 2 HOUR,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001010'), 90) DAY) + INTERVAL 6 HOUR,
  'Teslim edildi (extended seed).',
  31,
  1,
  NULL,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001010'), 90) DAY),
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001010'), 90) DAY) + INTERVAL 6 HOUR + INTERVAL 10 MINUTE
FROM cities c
...
SELECT
  ...
  x.qty,
  x.qty_del,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001010'), 90) DAY) + INTERVAL 20 MINUTE,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001010'), 90) DAY) + INTERVAL 20 MINUTE
FROM (
...
SELECT
  ...
  NULL,
  '11111111-1111-4111-8111-111111111111',
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001011'), 90) DAY) + INTERVAL 1 HOUR,
  '11111111-1111-4111-8111-111111111111',
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001011'), 90) DAY) + INTERVAL 2 HOUR,
  NULL,
  NULL,
  0,
  0,
  NULL,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001011'), 90) DAY),
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001011'), 90) DAY) + INTERVAL 2 HOUR + INTERVAL 10 MINUTE
FROM cities c
...
SELECT
  ...
  x.qty,
  x.qty_del,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001011'), 90) DAY) + INTERVAL 20 MINUTE,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001011'), 90) DAY) + INTERVAL 20 MINUTE
FROM (
...
SELECT
  ...
  NULL,
  '11111111-1111-4111-8111-111111111111',
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001012'), 90) DAY) + INTERVAL 1 HOUR,
  '11111111-1111-4111-8111-111111111111',
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001012'), 90) DAY) + INTERVAL 2 HOUR,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001012'), 90) DAY) + INTERVAL 6 HOUR,
  'Teslim edildi (extended seed).',
  40,
  1,
  NULL,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001012'), 90) DAY),
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001012'), 90) DAY) + INTERVAL 6 HOUR + INTERVAL 10 MINUTE
FROM cities c
...
SELECT
  ...
  x.qty,
  x.qty_del,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001012'), 90) DAY) + INTERVAL 20 MINUTE,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001012'), 90) DAY) + INTERVAL 20 MINUTE
FROM (
...
SELECT
  ...
  NULL,
  '11111111-1111-4111-8111-111111111111',
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001013'), 90) DAY) + INTERVAL 1 HOUR,
  '11111111-1111-4111-8111-111111111111',
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001013'), 90) DAY) + INTERVAL 2 HOUR,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001013'), 90) DAY) + INTERVAL 6 HOUR,
  'Teslim edildi (extended seed).',
  20,
  1,
  NULL,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001013'), 90) DAY),
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001013'), 90) DAY) + INTERVAL 6 HOUR + INTERVAL 10 MINUTE
FROM cities c
...
SELECT
  ...
  x.qty,
  x.qty_del,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001013'), 90) DAY) + INTERVAL 20 MINUTE,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001013'), 90) DAY) + INTERVAL 20 MINUTE
FROM (
...
SELECT
  ...
  NULL,
  '11111111-1111-4111-8111-111111111111',
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001014'), 90) DAY) + INTERVAL 1 HOUR,
  '11111111-1111-4111-8111-111111111111',
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001014'), 90) DAY) + INTERVAL 2 HOUR,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001014'), 90) DAY) + INTERVAL 6 HOUR,
  'Teslim edildi (extended seed).',
  22,
  1,
  NULL,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001014'), 90) DAY),
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001014'), 90) DAY) + INTERVAL 6 HOUR + INTERVAL 10 MINUTE
FROM cities c
...
SELECT
  ...
  x.qty,
  x.qty_del,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001014'), 90) DAY) + INTERVAL 20 MINUTE,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001014'), 90) DAY) + INTERVAL 20 MINUTE
FROM (
...
SELECT
  ...
  NULL,
  '11111111-1111-4111-8111-111111111111',
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001015'), 90) DAY) + INTERVAL 1 HOUR,
  '11111111-1111-4111-8111-111111111111',
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001015'), 90) DAY) + INTERVAL 2 HOUR,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001015'), 90) DAY) + INTERVAL 6 HOUR,
  'Teslim edildi (extended seed).',
  12,
  1,
  NULL,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001015'), 90) DAY),
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001015'), 90) DAY) + INTERVAL 6 HOUR + INTERVAL 10 MINUTE
FROM cities c
...
SELECT
  ...
  x.qty,
  x.qty_del,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001015'), 90) DAY) + INTERVAL 20 MINUTE,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001015'), 90) DAY) + INTERVAL 20 MINUTE
FROM (
...
SELECT
  ...
  NULL,
  '11111111-1111-4111-8111-111111111111',
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001016'), 90) DAY) + INTERVAL 1 HOUR,
  '11111111-1111-4111-8111-111111111111',
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001016'), 90) DAY) + INTERVAL 2 HOUR,
  NULL,
  NULL,
  0,
  0,
  NULL,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001016'), 90) DAY),
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001016'), 90) DAY) + INTERVAL 2 HOUR + INTERVAL 10 MINUTE
FROM cities c
...
SELECT
  ...
  x.qty,
  x.qty_del,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001016'), 90) DAY) + INTERVAL 20 MINUTE,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001016'), 90) DAY) + INTERVAL 20 MINUTE
FROM (
...
SELECT
  ...
  NULL,
  '11111111-1111-4111-8111-111111111111',
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001017'), 90) DAY) + INTERVAL 1 HOUR,
  '11111111-1111-4111-8111-111111111111',
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001017'), 90) DAY) + INTERVAL 2 HOUR,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001017'), 90) DAY) + INTERVAL 6 HOUR,
  'Teslim edildi (extended seed).',
  24,
  1,
  NULL,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001017'), 90) DAY),
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001017'), 90) DAY) + INTERVAL 6 HOUR + INTERVAL 10 MINUTE
FROM cities c
...
SELECT
  ...
  x.qty,
  x.qty_del,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001017'), 90) DAY) + INTERVAL 20 MINUTE,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001017'), 90) DAY) + INTERVAL 20 MINUTE
FROM (
...
SELECT
  ...
  NULL,
  '11111111-1111-4111-8111-111111111111',
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001018'), 90) DAY) + INTERVAL 1 HOUR,
  '11111111-1111-4111-8111-111111111111',
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001018'), 90) DAY) + INTERVAL 2 HOUR,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001018'), 90) DAY) + INTERVAL 6 HOUR,
  'Teslim edildi (extended seed).',
  32,
  1,
  NULL,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001018'), 90) DAY),
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001018'), 90) DAY) + INTERVAL 6 HOUR + INTERVAL 10 MINUTE
FROM cities c
...
SELECT
  ...
  x.qty,
  x.qty_del,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001018'), 90) DAY) + INTERVAL 20 MINUTE,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001018'), 90) DAY) + INTERVAL 20 MINUTE
FROM (
...
SELECT
  ...
  NULL,
  '11111111-1111-4111-8111-111111111111',
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001019'), 90) DAY) + INTERVAL 1 HOUR,
  '11111111-1111-4111-8111-111111111111',
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001019'), 90) DAY) + INTERVAL 2 HOUR,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001019'), 90) DAY) + INTERVAL 6 HOUR,
  'Teslim edildi (extended seed).',
  20,
  1,
  NULL,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001019'), 90) DAY),
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001019'), 90) DAY) + INTERVAL 6 HOUR + INTERVAL 10 MINUTE
FROM cities c
...
SELECT
  ...
  x.qty,
  x.qty_del,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001019'), 90) DAY) + INTERVAL 20 MINUTE,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001019'), 90) DAY) + INTERVAL 20 MINUTE
FROM (
...
SELECT
  ...
  NULL,
  '11111111-1111-4111-8111-111111111111',
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001020'), 90) DAY) + INTERVAL 1 HOUR,
  '11111111-1111-4111-8111-111111111111',
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001020'), 90) DAY) + INTERVAL 2 HOUR,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001020'), 90) DAY) + INTERVAL 6 HOUR,
  'Teslim edildi (extended seed).',
  34,
  1,
  NULL,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001020'), 90) DAY),
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001020'), 90) DAY) + INTERVAL 6 HOUR + INTERVAL 10 MINUTE
FROM cities c
...
SELECT
  ...
  x.qty,
  x.qty_del,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001020'), 90) DAY) + INTERVAL 20 MINUTE,
  DATE_SUB(CURRENT_TIMESTAMP(3), INTERVAL MOD(CRC32('90000000-0000-4000-8000-000000001020'), 90) DAY) + INTERVAL 20 MINUTE
FROM (
