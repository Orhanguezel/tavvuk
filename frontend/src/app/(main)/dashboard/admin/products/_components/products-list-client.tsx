...
// src/app/(main)/dashboard/admin/products/_components/products-list-client.tsx
...
export default function ProductsListClient() {
  ...
  function apply(next: Partial<ProductListParams>) {
    ...
    router.push(qs ? `/dashboard/admin/products?${qs}` : `/dashboard/admin/products`);
  }
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
        ...
        <Button asChild>
          <Link prefetch={false} href="/dashboard/admin/products/new">
                      ...
                      <TableCell className="text-right">
                        <div className="inline-flex items-center gap-2">
                          <Button asChild variant="outline" size="sm" disabled={busyAny || rb}>
                            <Link
                              prefetch={false}
                              href={`/dashboard/admin/products/${encodeURIComponent(p.id)}`}
                            >
                              Detay
                            </Link>
                          </Button>
