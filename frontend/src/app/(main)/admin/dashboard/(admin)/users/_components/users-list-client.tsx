...
// src/app/(main)/admin/users/_components/users-list-client.tsx
...
export default function UsersListClient() {
  ...
  function apply(next: Partial<AdminUsersListParams>) {
    ...
    router.push(qs ? `/admin/dashboard/users?${qs}` : `/admin/dashboard/users`);
  }
                  ...
                  <TableRow key={u.id}>
                    ...
                    <TableCell className="text-right">
                      <Button asChild variant="outline" size="sm">
                        <Link prefetch={false} href={`/admin/dashboard/users/${encodeURIComponent(u.id)}`}>
                          Detay
                        </Link>
                      </Button>
                    </TableCell>
